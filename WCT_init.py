...
def train_GCN(treeDic, x_test, x_train, target_train, TDdroprate, BUdroprate, lr, weight_decay, patience, n_epochs,
    ...
    log_train = 'model/' + dataname +'/logs/' + dataname + '/' + 'Source_train' + run_time
    writer_train = SummaryWriter(log_train)
    log_val = 'model/' + dataname +'/logs/' + dataname + '/' + 'Sourcer_val' + run_time
    writer_val = SummaryWriter(log_val)
    log_test = 'model/' + dataname +'/logs/' + dataname + '/' + 'Target_test' + run_time
