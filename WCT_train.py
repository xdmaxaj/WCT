...
def train_AT(treeDic, x_test, x_train, target_train, TDdroprate, BUdroprate, noise_rate,lr, weight_decay, patience, n_epochs,
    ...
    #  creat log file
    log_train_source ='model/' + dataname.split('_')[1] + '/logs/' + dataname.split('_')[0] + '_with_WCT' + '/' + 'Source_train' + run_time
    writer_train_source = SummaryWriter(log_train_source)

    log_train = 'model/' + dataname.split('_')[1] + '/logs/' + dataname.split('_')[0] + '_with_WCT' + '/' + 'Target_train' + run_time
    writer_train = SummaryWriter(log_train)

    log_test = 'model/' + dataname.split('_')[1] + '/logs/' + dataname.split('_')[0] + '_with_WCT' + '/' + 'Target_test' + run_time
    ...
    #  build teacher model
    model_teacher = Net(768, 512, 128, 0.1).to(device)
